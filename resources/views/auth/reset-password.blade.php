<x-layouts.auth>
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div>
            ...
            <x-brezee.text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-brezee.text-input id="password" class="block mt-1 w-full" type="password" name="password" required autocomplete="new-password" />
