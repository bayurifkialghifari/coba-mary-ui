<x-layouts.auth>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <x-brezee.text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-brezee.primary-button class="ms-3">
                {{ __('Log in') }}
